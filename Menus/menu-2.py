...
button4 = Button(labelPadding * " " + "     Nmap", originX, originY + buttonHeight + spacing, buttonHeight, buttonWidth, tron_blu, tron_whi, labelFont)
button5 = Button(labelPadding * " " + "   Printers", originX + buttonWidth + spacing, originY + buttonHeight + spacing, buttonHeight, buttonWidth, tron_blu, tron_whi, labelFont)
button6 = Button(labelPadding * " " + " Responder", originX + (buttonWidth * 2) + (spacing * 2), originY + buttonHeight + spacing, buttonHeight, buttonWidth, tron_blu, tron_whi, labelFont)
...
def button(number):
	...
	# Nmap Scan
        pygame.quit()
        kalipi.run_cmd("/opt/hackbox/nmapscan.sh")
    ...
    if number == 5:
        ...
        # Discoverprinters
        pygame.quit()
        kalipi.run_cmd("/opt/hackbox/discoverprinters.sh")
        os.execv(__file__, sys.argv)
    ...
    if number == 6:
        ...
        # Responder
        # pygame.quit()
        # kalipi.run_cmd("/opt/hackbox/responder.sh")
        # os.execv(__file__, sys.argv)
        return
